...
<!--theme-style-->
<link href="<?php echo base_url()?>assets/css/style4.css" rel="stylesheet" type="text/css" media="all" />
<!--//theme-style-->
<script src="<?php echo base_url()?>assets/js/jquery.min.js"></script>
<!--- start-rate---->
<script src="<?php echo base_url()?>assets/js/jstarbox.js"></script>
	<link rel="stylesheet" href="<?php base_url()?>assets/css/jstarbox.css" type="text/css" media="screen" charset="utf-8" />
...
<!---//End-rate---->
    ...
    <link rel="stylesheet" href="<?php base_url()?>assets/css/chocolat.css" type="text/css" media="screen" charset="utf-8">
    <!--light-box-files -->
